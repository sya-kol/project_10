...
@pytest.mark.parametrize('info_numbers, expected', [('Maestro 1596837868705199', 'Maestro 1596 83** **** 5199'),
...
@pytest.mark.parametrize('number_card_account, expected', [('maestro 1596837868705199', 'maestro 1596 83** **** 5199'),
                                                    ('счет 73654108430135874305', 'счет **4305'),
                                                    ('СЧЕТ 35383033474447895560', 'СЧЕТ **5560'),
...
@pytest.mark.parametrize('data_info, expected', [('2024-03-11T02:26:18.671407', '11.03.2024'),
                                                 ('2024-03-11T02:26:18', '11.03.2024')])
def test_mask_account_card(data_info, expected):
